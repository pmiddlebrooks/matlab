...
stopCorrectGoTargTrial	= cell(1, length(pSignalArray));
...
stopCorrectGoTargRT   = cell(1, length(pSignalArray));
...
goTargStopCorrectGoTargRT   = cell(1, length(pSignalArray)); % rt to last goTarget in trial sequence goTarget --> stopCorrect --> goTarget
goTargGoDistGoTargRT   = cell(1, length(pSignalArray)); % rt to last goTarget in trial sequence goTarget --> stopCorrect --> goTarget
...
goTargRTStopCorrectGoTarg   = cell(1, length(pSignalArray)); % rt to first goTarget in trial sequence goTarget --> stopCorrect --> goTarget
goTargRTGoDistGoTarg   = cell(1, length(pSignalArray)); % rt to first goTarget in trial sequence goTarget --> stopCorrect --> goTarget
...
stopCorrectGoTrial	= cell(1, length(pSignalArray));
...
stopCorrectGoRT   = cell(1, length(pSignalArray));
...
stopCorrectTrial    = ccm_trial_selection(trialData, selectOpt);
back1StopCorrectTrial = stopCorrectTrial + 1;
...
for iPropIndex = 1 : length(pSignalArray);
   ...
   stopCorrectGoTargTrial{iPropIndex}  = intersect(back1StopCorrectTrial, iGoTargTrial);
   stopCorrectGoTargRT{iPropIndex} = allRT(stopCorrectGoTargTrial{iPropIndex});
   ...
   % Last trial was Stop Correct
   stopCorrectGoTrial{iPropIndex}  = intersect(back1StopCorrectTrial, iGoTrial);
   stopCorrectGoRT{iPropIndex} = allRT(stopCorrectGoTrial{iPropIndex});
   ...
   goTargStopCorrectGoTargTrial{iPropIndex} = intersect(stopCorrectGoTargTrial{iPropIndex}, back2GoTargTrial);
...
stopCorrectGoTargRTMean = cellfun(@nanmean, stopCorrectGoTargRT);
...
stopCorrectGoRTMean = cellfun(@nanmean, stopCorrectGoRT);
...
stopCorrectGoTargDiffMean = cellfun(@nanmean, stopCorrectGoTargDiff);
...
stopCorrectGoTargRTMeanCollapse = nanmean(cell2mat(stopCorrectGoTargRT'));
...
stopCorrectGoRTMeanCollapse = nanmean(cell2mat(stopCorrectGoRT'));
...
% trial outcome in any signal strength
% ********************************************************************
nGoDistStopCorrect      = length(intersect(back1GoDistTrial, stopCorrectTrial));
nGoDistStop            = length(intersect(back1GoDistTrial, [stopIncorrectTrial; stopCorrectTrial]));
pGoDistStopCorrectCollapse = nGoDistStopCorrect / nGoDistStop;
nGoTargStopCorrect      = length(intersect(back1GoTargTrial, stopCorrectTrial));
nGoTargStop             = length(intersect(back1GoTargTrial, [stopIncorrectTrial; stopCorrectTrial]));
pGoTargStopCorrectCollapse = nGoTargStopCorrect / nGoTargStop;
nStopCorrectStopCorrect      = length(intersect(back1StopCorrectTrial, stopCorrectTrial));
nStopCorrectStop            = length(intersect(back1StopCorrectTrial, [stopIncorrectTrial; stopCorrectTrial]));
pStopCorrectStopCorrectCollapse = nStopCorrectStopCorrect / nStopCorrectStop;
nStopIncorrectStopCorrect      = length(intersect(back1StopIncorrectTrial, stopCorrectTrial));
nStopIncorrectStop            = length(intersect(back1StopIncorrectTrial, [stopIncorrectTrial; stopCorrectTrial]));
...
goStopCorrGoBeforeTrial = intersect(stopCorrectTrial, intersect(goTargTrial-1, goTargTrial+1)) - 1;
goStopCorrGoAfterTrial  = intersect(stopCorrectTrial, intersect(goTargTrial-1, goTargTrial+1)) + 1;
...
stopCorrectGoTargDiffCollapse = nanmean(cell2mat(stopCorrectGoTargDiff));
...
data.stopCorrectGoTargRT    = stopCorrectGoTargRT;
...
data.stopCorrectGoRT        = stopCorrectGoRT;
...
if plotFlag
   ...
   plot(ax(axXGoTarg), pSignalArray, stopCorrectGoTargRTMean, '-o', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   legend(ax(axXGoTarg), {'goTargGoTarg', 'goDistGoTarg', 'stopTargGoTarg', 'stopDistGoTarg', 'stopCorrectGoTarg'})
   ...
   plot(ax(axXGoTarg), pSignalArray(1) - choicePlotXMargin+.01, stopCorrectGoTargRTMeanCollapse, '-d', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   ...
   plot(ax(axXGoTarg2), pSignalArray, stopCorrectGoTargRTMean, '-o', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   legend(ax(axXGoTarg2), {'goGoTarg', 'stopIncorrectGoTarg', 'stopCorrectGoTarg'})
   ...
   plot(ax(axXGoTarg2), pSignalArray(1) - choicePlotXMargin+.01, stopCorrectGoTargRTMeanCollapse, '-d', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   ...
   plot(ax(axXGo), pSignalArray, stopCorrectGoRTMean, '-o', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   legend(ax(axXGo), {'goTargGo', 'goDistGo', 'stopTargGo', 'stopDistGo', 'stopCorrectGo'})
   ...
   plot(ax(axXGo), pSignalArray(1) - choicePlotXMargin+.01, stopCorrectGoRTMeanCollapse, '-d', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   ...
   %         set(ax(axXGo),'YLim',[min([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) - 25, max([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) + 25])
   ...
   plot(ax(axXGo2), pSignalArray, stopCorrectGoRTMean, '-o', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   legend(ax(axXGo2), {'goGo', 'stopIncorrectGo', 'stopCorrectGo'})
   ...
   plot(ax(axXGo2), pSignalArray(1) - choicePlotXMargin+.01, stopCorrectGoRTMeanCollapse, '-d', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   ...
   %         set(ax(axXGo2),'YLim',[min([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) - 25, max([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) + 25])
   ...
   %         set(ax(axGoDistX),'YLim',[min([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) - 25, max([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) + 25])
   ...
   %         set(ax(axGoDistX2),'YLim',[min([goTargGoRTMean{:}; stopTargGoRTMean{:}; stopCorrectGoRTMean{:}]) - 25, max([goTargGoRTMean{:}; stopTargGoRTMean{:}; stopCorrectGoRTMean{:}]) + 25])
   ...
   plot(ax(axStopP), pSignalArray, cell2mat(pStopCorrectStopCorrect), '-o', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   ...
   plot(ax(axStopP), pSignalArray(1) - choicePlotXMargin+.01, pStopCorrectStopCorrectCollapse, '-d', 'color', stopCorrectColor, 'linewidth', 1, 'markerfacecolor', stopCorrectColor, 'markeredgecolor', stopCorrectColor)
   ...
   plot(ax(axTriplet), pSignalArray, stopCorrectGoTargDiffMean, '--o', 'color', stopDistColor, 'linewidth', 1, 'markerfacecolor', stopDistColor, 'markeredgecolor', stopDistColor)
   ...
   plot(ax(axTriplet), pSignalArray(1) - choicePlotXMargin+.01, stopCorrectGoTargDiffCollapse, '--d', 'color', stopDistColor, 'linewidth', 1, 'markerfacecolor', stopDistColor, 'markeredgecolor', stopDistColor)
   ...
   %     set(ax(axTriplet),'YLim',[min([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) - 25, max([goTargGoRTMean; stopTargGoRTMean; stopCorrectGoRTMean]) + 25])
