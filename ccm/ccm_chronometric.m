...
for kTarg = 1 : nTargPair
   ...
   if plotFlag
      ...
      set(ax(pRightvRT),'YLim',[min([stopLeftToTargMean, stopRightToTargMean, stopLeftToDistMean, stopRightToDistMean]) - 25, max([goLeftToTargMean, goRightToTargMean, goLeftToDistMean, goRightToDistMean]) + 25])
