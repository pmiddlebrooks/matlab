...
fig
subplot(2,2,1)
plot(-500:2500,nanmean(OL(contraCorrectOL_nostim,:)),'b',-500:2500,nanmean(OL(ipsiCorrectOL_nostim,:)),'--b')
...
subplot(2,2,2)
plot(-500:2500,nanmean(OR(contraCorrectOR_nostim,:)),'b',-500:2500,nanmean(OR(ipsiCorrectOR_nostim,:)),'--b')
axis ij
xlim([-50 300])
...
subplot(2,2,3)
plot(-500:2500,nanmean(OL(contraCorrectOL_stim,:)),'r',-500:2500,nanmean(OL(ipsiCorrectOL_stim,:)),'--r')
axis ij
xlim([-50 300])
vline(TDT.OL.stim,'r')
fon
...
subplot(2,2,4)
plot(-500:2500,nanmean(OR(contraCorrectOR_stim,:)),'r',-500:2500,nanmean(OR(ipsiCorrectOR_stim,:)),'--r')
axis ij
xlim([-50 300])
vline(TDT.OR.stim,'r')
fon
