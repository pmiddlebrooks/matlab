function prospective_monitoring_saccade(soaArrayScreenFlips, nTarget, targetAmplitude, targetAngles, betAngle, targetDistribution, plotFlag, saveFlag)
