function ssrt = get_ssrt_post_ssd(ssd,pRespond,nStop,goRT)
% function ssrt = get_ssrt_post_ssd(ssd,pRespond,nStop,goRT,WeibParams)
% SSRT
...
for i = 1 : length(ssd)
    ...
    iGoRT = sort(goRT{i}(~isnan(goRT{i})));
    p_goRT      = 1/length(iGoRT):1/length(iGoRT):1; %y-axis of a cumulative prob dist
    ...
    if isnan(iPResp) || ...
        ...
        ssrtEach(i) = iGoRT(indexRT) - iSSD; %this is the SSRT by the method of integration
    end
