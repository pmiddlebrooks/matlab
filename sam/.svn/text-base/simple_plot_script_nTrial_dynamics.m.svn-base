...
colSTOPAvg = [1 0 0];
 ...
 % how thick is the single trial line width?
 if nTrialSim < 5
   singleLW = 2;
else
singleLW = 1;
...
if prd.pGoCorr(iCnd) > 0
  ...
  sXGOT = prd.dyn{iCnd,iGoTrType}.GoCorr.goStim.GOT.sX(1:nTrialSim);
  sYGOT = prd.dyn{iCnd,iGoTrType}.GoCorr.goStim.GOT.sY(1:nTrialSim);
  sXGONT = prd.dyn{iCnd,iGoTrType}.GoCorr.goStim.GONT.sX(1:nTrialSim);
  sYGONT = prd.dyn{iCnd,iGoTrType}.GoCorr.goStim.GONT.sY(1:nTrialSim);
...
%   cellfun(@(a,b) patchline(a,b,'EdgeColor',colGONT,'LineWidth',1,'EdgeAlpha',edgeAlpha),sXGONT,sYGONT,'Uni',0);
  ...
  % Plot data
  cellfun(@(a,b) plot(a,b,'Color',colGONT,'LineWidth',singleLW),sXGONT,sYGONT,'Uni',0);
  cellfun(@(a,b) plot(a,b,'Color',colGOT,'LineWidth',singleLW),sXGOT,sYGOT,'Uni',0);
...
if prd.pGoComm(iCnd) > 0
  ...
  % Get individual trial dynamics
  sXGOT = prd.dyn{iCnd,iGoTrType}.GoComm.goStim.GOT.sX(1:nTrialSim);
  sYGOT = prd.dyn{iCnd,iGoTrType}.GoComm.goStim.GOT.sY(1:nTrialSim);
  sXGONTE = prd.dyn{iCnd,iGoTrType}.GoComm.goStim.GONTE.sX(1:nTrialSim);
  sYGONTE = prd.dyn{iCnd,iGoTrType}.GoComm.goStim.GONTE.sY(1:nTrialSim);
  ...
  % Plot data
  cellfun(@(a,b) plot(a,b,'Color',colGOT,'LineWidth',singleLW),sXGOT,sYGOT,'Uni',0);
  cellfun(@(a,b) plot(a,b,'Color',colGONTE,'LineWidth',singleLW),sXGONTE,sYGONTE,'Uni',0);
...
% 
    ...
    if prd.pStopSuccess(iCnd,iStopTrType-1) > 0
      ...
      % Get individual trial dynamics
      sXSTOP = prd.dyn{iCnd,iStopTrType}.StopSuccess.goStim.STOP.sX(1:nTrialSim);
      sYSTOP = prd.dyn{iCnd,iStopTrType}.StopSuccess.goStim.STOP.sY(1:nTrialSim);
      sXGOT = prd.dyn{iCnd,iStopTrType}.StopSuccess.goStim.GOT.sX(1:nTrialSim);
      sYGOT = prd.dyn{iCnd,iStopTrType}.StopSuccess.goStim.GOT.sY(1:nTrialSim);
      ...
      % Plot data
      cellfun(@(a,b) plot(a,b,'Color',colGOT,'LineWidth',singleLW),sXGOT,sYGOT,'Uni',0);
      cellfun(@(a,b) plot(a,b,'Color',colSTOP,'LineWidth',singleLW),sXSTOP,sYSTOP,'Uni',0);
...
% 
  ...
  set(gca,'XLim',xDataLim,'YLim',yDataLim);
    ...
    if prd.pStopFailure(iCnd,iStopTrType-1)
      ...
      % Get individual trial dynamics
      sXSTOP = prd.dyn{iCnd,iStopTrType}.StopFailure.goStim.STOP.sX(1:nTrialSim);
      sYSTOP = prd.dyn{iCnd,iStopTrType}.StopFailure.goStim.STOP.sY(1:nTrialSim);
      sXGORESP = prd.dyn{iCnd,iStopTrType}.StopFailure.goStim.GORESP.sX(1:nTrialSim);
      sYGORESP = prd.dyn{iCnd,iStopTrType}.StopFailure.goStim.GORESP.sY(1:nTrialSim);
      ...
      % Plot data
      cellfun(@(a,b) plot(a,b,'Color',colSTOP,'LineWidth',singleLW),sXSTOP,sYSTOP,'Uni',0);
      cellfun(@(a,b) plot(a,b,'Color',colGOT,'LineWidth',singleLW),sXGORESP,sYGORESP,'Uni',0);
