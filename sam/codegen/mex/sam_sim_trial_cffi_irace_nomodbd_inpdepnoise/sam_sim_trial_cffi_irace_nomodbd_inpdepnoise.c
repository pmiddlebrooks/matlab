/*
 * sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.c
 *
 * Code generation for function 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise'
 *
 * C source code generated on: Wed Oct 30 11:46:36 2013
 *
 */

/* Include files */
#include "rt_nonfinite.h"
#include "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.h"
#include "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise_emxutil.h"
#include "diag.h"
#include "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 103,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo b_emlrtRSI = { 113,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo c_emlrtRSI = { 117,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo d_emlrtRSI = { 121,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo e_emlrtRSI = { 125,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo f_emlrtRSI = { 55, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtRSInfo g_emlrtRSI = { 21, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtRSInfo h_emlrtRSI = { 84, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtRSInfo i_emlrtRSI = { 89, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };
...
static emlrtRSInfo l_emlrtRSI = { 32, "eml_blas_xgemm",
...
static emlrtRSInfo t_emlrtRSI = { 110, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo u_emlrtRSI = { 111, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo v_emlrtRSI = { 112, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo w_emlrtRSI = { 113, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo x_emlrtRSI = { 114, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo y_emlrtRSI = { 115, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo ab_emlrtRSI = { 119, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo bb_emlrtRSI = { 122, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo cb_emlrtRSI = { 125, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo db_emlrtRSI = { 128, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo eb_emlrtRSI = { 131, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo fb_emlrtRSI = { 134, "eml_blas_xgemm",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_blas_xgemm.m"
};

static emlrtRSInfo gb_emlrtRSI = { 14, "eml_c_cast",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/blas/external/eml_c_cast.m"
};

static emlrtRSInfo ib_emlrtRSI = { 88, "randn",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/randfun/randn.m" };

static emlrtRSInfo jb_emlrtRSI = { 14, "sqrt",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/elfun/sqrt.m" };

static emlrtRSInfo kb_emlrtRSI = { 20, "eml_error",
...
static emlrtRSInfo nb_emlrtRSI = { 26, "eml_li_find",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };

static emlrtRSInfo ob_emlrtRSI = { 39, "eml_li_find",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };
...
static emlrtMCInfo emlrtMCI = { 85, 13, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtMCInfo b_emlrtMCI = { 84, 23, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtMCInfo c_emlrtMCI = { 90, 13, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtMCInfo d_emlrtMCI = { 89, 23, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };
...
static emlrtMCInfo g_emlrtMCI = { 88, 9, "randn",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/randfun/randn.m" };

static emlrtMCInfo h_emlrtMCI = { 14, 5, "eml_li_find",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };
...
static emlrtRTEInfo emlrtRTEI = { 1, 24,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};
...
static emlrtRTEInfo e_emlrtRTEI = { 103, 3,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};
...
static emlrtECInfo emlrtECI = { -1, 121, 6,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtECInfo b_emlrtECI = { -1, 117, 8,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo emlrtBCI = { -1, -1, 117, 12, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo c_emlrtECI = { -1, 113, 3,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo b_emlrtBCI = { -1, -1, 113, 20, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo d_emlrtECI = { -1, 113, 5,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo c_emlrtBCI = { -1, -1, 113, 9, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo e_emlrtECI = { -1, 113, 31,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo d_emlrtBCI = { -1, -1, 113, 35, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo f_emlrtECI = { -1, 109, 3,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo e_emlrtBCI = { -1, -1, 109, 7, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo g_emlrtECI = { -1, 109, 14,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo f_emlrtBCI = { -1, -1, 109, 18, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo h_emlrtECI = { -1, 103, 10,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo g_emlrtBCI = { -1, -1, 105, 32, "u",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo h_emlrtBCI = { -1, -1, 104, 25, "u",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo i_emlrtBCI = { -1, -1, 103, 18, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtDCInfo emlrtDCI = { 103, 18,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  1 };

static emlrtECInfo i_emlrtECI = { -1, 61, 1,
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo j_emlrtBCI = { -1, -1, 61, 5, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo k_emlrtBCI = { -1, -1, 113, 5, "z",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo l_emlrtBCI = { -1, -1, 113, 27, "ZLB",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo m_emlrtBCI = { -1, -1, 117, 3, "resp",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo n_emlrtBCI = { -1, -1, 121, 3, "rt",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo o_emlrtBCI = { -1, -1, 121, 26, "T",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo p_emlrtBCI = { -1, -1, 125, 10, "terminate",
  "sam_sim_trial_cffi_irace_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.m",
  0 };
  ...
  *location)
{
  ...
  pArrays[0] = b;
  pArrays[1] = c;
  return emlrtCallMATLABR2012b(emlrtRootTLSGlobal, 1, &m5, 2, pArrays, "randn",
    TRUE, location);
}
 ...
 *                                                          z)
 */
void sam_sim_trial_cffi_irace_nomodbd_inpdepnoise(const emxArray_real_T *u,
  const emxArray_real_T *A, const emxArray_real_T *unusedU0, const
  emxArray_real_T *C, const emxArray_real_T *unusedU1, const emxArray_real_T *SI,
  const emxArray_real_T *Z0, const emxArray_real_T *ZC, const emxArray_real_T
  *ZLB, real_T dt, real_T tau, const emxArray_real_T *T, const
  emxArray_boolean_T *terminate, const emxArray_boolean_T *unusedU2, const
  emxArray_boolean_T *unusedU3, real_T n, real_T unusedU4, real_T p, real_T t,
  emxArray_real_T *rt, emxArray_boolean_T *resp, emxArray_real_T *z)
{
  emxArray_int32_T *r1;
  int32_T loop_ub;
  int32_T i5;
  ...
  /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:61' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i5 = r1->size[0];
  r1->size[0] = loop_ub;
  emxEnsureCapacity((emxArray__common *)r1, i5, (int32_T)sizeof(int32_T),
                    &emlrtRTEI);
  ...
  i5 = z->size[1];
  emlrtDynamicBoundsCheckFastR2012b(1, 1, i5, &j_emlrtBCI, emlrtRootTLSGlobal);
  iv17[0] = r1->size[0];
  emlrtSubAssignSizeCheckR2012b(iv17, 1, *(int32_T (*)[1])Z0->size, 1,
  ...
  loop_ub = r1->size[0];
  for (i5 = 0; i5 < loop_ub; i5++) {
    r2->data[i5] = r1->data[i5];
  }

  i = r1->size[0];
  for (i5 = 0; i5 < i; i5++) {
    z->data[r2->data[i5]] = Z0->data[i5];
  }
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:67' while t < p - 1 */
  ...
  b_emxInit_boolean_T(&b_b, 2, &emlrtRTEI, TRUE);
  ...
  emxInit_boolean_T(&b_u, 1, &emlrtRTEI, TRUE);
  c_emxInit_real_T(&e_z, 1, &emlrtRTEI, TRUE);
  c_emxInit_real_T(&c_u, 1, &emlrtRTEI, TRUE);
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:103' dzdt = A * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:104'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:105'                 SI * diag((u(:,t) ~= 0)) * randn(n,1) * sqrt(dt/tau); */
    ...
    loop_ub = z->size[0];
    i5 = z->size[1];
    i6 = (int32_T)emlrtIntegerCheckFastR2012b(t, &emlrtDCI, emlrtRootTLSGlobal);
    i = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &i_emlrtBCI,
      emlrtRootTLSGlobal);
    i5 = b->size[0];
    b->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)b, i5, (int32_T)sizeof(real_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < loop_ub; i5++) {
      b->data[i5] = z->data[i5 + z->size[0] * (i - 1)];
    }

    emlrtPushRtStackR2012b(&g_emlrtRSI, emlrtRootTLSGlobal);
    i5 = z->size[0];
    innerDimOk = (A->size[1] == i5);
    if (!innerDimOk) {
      guard4 = FALSE;
      if ((A->size[0] == 1) && (A->size[1] == 1)) {
        ...
        if (i5 == 1) {
          ...
          emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m6, cv5);
          emlrtAssign(&c_y, m6);
      ...
      if (guard4 == TRUE) {
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 45, m6, cv7);
        emlrtAssign(&d_y, m6);
    ...
    if (A->size[1] == 1) {
      ...
      if (i5 == 1) {
        ...
        unnamed_idx_0 = (int8_T)A->size[0];
        emlrtPushRtStackR2012b(&f_emlrtRSI, emlrtRootTLSGlobal);
        emlrtPushRtStackR2012b(&j_emlrtRSI, emlrtRootTLSGlobal);
        i5 = dzdt->size[0];
        dzdt->size[0] = unnamed_idx_0;
        emxEnsureCapacity((emxArray__common *)dzdt, i5, (int32_T)sizeof(real_T),
                          &emlrtRTEI);
    ...
    if (guard3 == TRUE) {
      ...
      i5 = e_z->size[0];
      e_z->size[0] = loop_ub;
      emxEnsureCapacity((emxArray__common *)e_z, i5, (int32_T)sizeof(real_T),
                        &emlrtRTEI);
      for (i5 = 0; i5 < loop_ub; i5++) {
        e_z->data[i5] = z->data[i5 + z->size[0] * ((int32_T)t - 1)];
      }

      i5 = dzdt->size[0];
      dzdt->size[0] = A->size[0];
      emxEnsureCapacity((emxArray__common *)dzdt, i5, (int32_T)sizeof(real_T),
                        &emlrtRTEI);
      loop_ub = A->size[0];
      for (i5 = 0; i5 < loop_ub; i5++) {
        ...
        for (i6 = 0; i6 < b_loop_ub; i6++) {
          dzdt->data[i5] += A->data[i5 + A->size[0] * i6] * e_z->data[i6];
        }
      }
    }
    ...
    loop_ub = dzdt->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      dzdt->data[i5] = dzdt->data[i5] * dt / tau;
    }
    ...
    i5 = u->size[1];
    i6 = (int32_T)t;
    i = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &h_emlrtBCI,
      emlrtRootTLSGlobal);
    i5 = b->size[0];
    b->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)b, i5, (int32_T)sizeof(real_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < loop_ub; i5++) {
      b->data[i5] = u->data[i5 + u->size[0] * (i - 1)];
    }

    emlrtPushRtStackR2012b(&g_emlrtRSI, emlrtRootTLSGlobal);
    i5 = u->size[0];
    innerDimOk = (C->size[1] == i5);
    if (!innerDimOk) {
      guard2 = FALSE;
      if ((C->size[0] == 1) && (C->size[1] == 1)) {
        ...
        if (i5 == 1) {
          ...
          emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m6, cv5);
          emlrtAssign(&e_y, m6);
          error(message(e_y, &c_emlrtMCI), &d_emlrtMCI);
          emlrtPopRtStackR2012b(&i_emlrtRSI, emlrtRootTLSGlobal);
        }
      }
    ...
    if (guard1 == TRUE) {
      ...
      i5 = c_u->size[0];
      c_u->size[0] = loop_ub;
      emxEnsureCapacity((emxArray__common *)c_u, i5, (int32_T)sizeof(real_T),
                        &emlrtRTEI);
      for (i5 = 0; i5 < loop_ub; i5++) {
        c_u->data[i5] = u->data[i5 + u->size[0] * ((int32_T)t - 1)];
      }
      ...
      for (i5 = 0; i5 < loop_ub; i5++) {
        ...
        b_loop_ub = C->size[1];
        for (i6 = 0; i6 < b_loop_ub; i6++) {
          y->data[i5] += C->data[i5 + C->size[0] * i6] * c_u->data[i6];
        }
      }
    }
    ...
    loop_ub = y->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      y->data[i5] = y->data[i5] * dt / tau;
    }

    emlrtPopRtStackR2012b(&emlrtRSI, emlrtRootTLSGlobal);
    i5 = dzdt->size[0];
    i6 = y->size[0];
    emlrtSizeEqCheck1DFastR2012b(i5, i6, &h_emlrtECI, emlrtRootTLSGlobal);
    emlrtPushRtStackR2012b(&emlrtRSI, emlrtRootTLSGlobal);
    loop_ub = u->size[0];
    i5 = u->size[1];
    i6 = (int32_T)t;
    i = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &g_emlrtBCI,
      emlrtRootTLSGlobal);
    i5 = b_u->size[0];
    b_u->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)b_u, i5, (int32_T)sizeof(boolean_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < loop_ub; i5++) {
      b_u->data[i5] = (u->data[i5 + u->size[0] * (i - 1)] != 0.0);
    }

    diag(b_u, b_b);
    emlrtPushRtStackR2012b(&g_emlrtRSI, emlrtRootTLSGlobal);
    innerDimOk = (SI->size[1] == b_b->size[0]);
    if (!innerDimOk) {
      if (((SI->size[0] == 1) && (SI->size[1] == 1)) || ((b_b->size[0] == 1) &&
           (b_b->size[1] == 1))) {
        emlrtPushRtStackR2012b(&h_emlrtRSI, emlrtRootTLSGlobal);
        g_y = NULL;
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      ...
      for (i6 = 0; i6 < b_loop_ub; i6++) {
        ...
        for (i = 0; i < c_loop_ub; i++) {
          a->data[i5 + a->size[0] * i6] += SI->data[i5 + SI->size[0] * i] *
            (real_T)b_b->data[i + b_b->size[0] * i6];
        }
      }
    }
    ...
    i_y = NULL;
    m6 = mxCreateDoubleScalar(n);
    emlrtAssign(&i_y, m6);
    j_y = NULL;
    m6 = mxCreateDoubleScalar(1.0);
    emlrtAssign(&j_y, m6);
    emlrt_marshallIn(randn(i_y, j_y, &g_emlrtMCI), "randn", b);
    emlrtPopRtStackR2012b(&ib_emlrtRSI, emlrtRootTLSGlobal);
    emlrtPushRtStackR2012b(&g_emlrtRSI, emlrtRootTLSGlobal);
    innerDimOk = (a->size[1] == b->size[0]);
    if (!innerDimOk) {
      if (((a->size[0] == 1) && (a->size[1] == 1)) || (b->size[0] == 1)) {
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 45, m6, cv7);
        emlrtAssign(&k_y, m6);
        error(message(k_y, &emlrtMCI), &b_emlrtMCI);
        emlrtPopRtStackR2012b(&h_emlrtRSI, emlrtRootTLSGlobal);
      } else {
        emlrtPushRtStackR2012b(&i_emlrtRSI, emlrtRootTLSGlobal);
        l_y = NULL;
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m6, cv5);
        emlrtAssign(&l_y, m6);
        error(message(l_y, &c_emlrtMCI), &d_emlrtMCI);
        emlrtPopRtStackR2012b(&i_emlrtRSI, emlrtRootTLSGlobal);
      }
    }
    ...
    if ((a->size[1] == 1) || (b->size[0] == 1)) {
      i5 = b_y->size[0];
      b_y->size[0] = a->size[0];
      emxEnsureCapacity((emxArray__common *)b_y, i5, (int32_T)sizeof(real_T),
                        &emlrtRTEI);
      loop_ub = a->size[0];
      for (i5 = 0; i5 < loop_ub; i5++) {
        b_y->data[i5] = 0.0;
        b_loop_ub = a->size[1];
        for (i6 = 0; i6 < b_loop_ub; i6++) {
          b_y->data[i5] += a->data[i5 + a->size[0] * i6] * b->data[i6];
        }
      }
    } else {
      unnamed_idx_0 = (int8_T)a->size[0];
    ...
    loop_ub = dzdt->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      dzdt->data[i5] = (dzdt->data[i5] + y->data[i5]) + b_y->data[i5];
    }

    /*  Noise (in) */
    /*  Log new activation level */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:109' z(:,t+1) = z(:,t) + dzdt; */
    i5 = z->size[1];
    i6 = (int32_T)t;
    emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &f_emlrtBCI, emlrtRootTLSGlobal);
    i5 = z->size[0];
    i6 = dzdt->size[0];
    emlrtSizeEqCheck1DFastR2012b(i5, i6, &g_emlrtECI, emlrtRootTLSGlobal);
    loop_ub = z->size[0];
    i5 = r1->size[0];
    r1->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)r1, i5, (int32_T)sizeof(int32_T),
    ...
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &e_emlrtBCI, emlrtRootTLSGlobal);
    iv26[0] = r1->size[0];
    loop_ub = z->size[0];
    i5 = f_z->size[0];
    f_z->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)f_z, i5, (int32_T)sizeof(real_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < loop_ub; i5++) {
      f_z->data[i5] = z->data[i5 + z->size[0] * ((int32_T)t - 1)];
    }
    ...
    loop_ub = r1->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      r4->data[i5] = r1->data[i5];
    }

    i = z->size[0];
    i5 = g_z->size[0];
    g_z->size[0] = i;
    emxEnsureCapacity((emxArray__common *)g_z, i5, (int32_T)sizeof(real_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < i; i5++) {
      g_z->data[i5] = z->data[i5 + z->size[0] * ((int32_T)t - 1)] + dzdt->
        data[i5];
    }

    loop_ub = g_z->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      z->data[r4->data[i5] + z->size[0] * (int32_T)t] = g_z->data[i5];
    }

    /*  Rectify activation if below zLB */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:113' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &d_emlrtBCI, emlrtRootTLSGlobal);
    i5 = z->size[0];
    i6 = ZLB->size[0];
    emlrtSizeEqCheck1DFastR2012b(i5, i6, &e_emlrtECI, emlrtRootTLSGlobal);
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &c_emlrtBCI, emlrtRootTLSGlobal);
    i5 = z->size[0];
    i6 = ZLB->size[0];
    emlrtSizeEqCheck1DFastR2012b(i5, i6, &d_emlrtECI, emlrtRootTLSGlobal);
    emlrtPushRtStackR2012b(&b_emlrtRSI, emlrtRootTLSGlobal);
    loop_ub = z->size[0];
    i5 = d_z->size[0];
    d_z->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)d_z, i5, (int32_T)sizeof(boolean_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < loop_ub; i5++) {
      d_z->data[i5] = (z->data[i5 + z->size[0] * (int32_T)t] < ZLB->data[i5]);
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = z->size[0];
      i = r1->data[i5];
      r3->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i, 1, i6, &k_emlrtBCI,
    ...
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &b_emlrtBCI, emlrtRootTLSGlobal);
    emlrtPushRtStackR2012b(&b_emlrtRSI, emlrtRootTLSGlobal);
    loop_ub = z->size[0];
    i5 = c_z->size[0];
    c_z->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)c_z, i5, (int32_T)sizeof(boolean_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < loop_ub; i5++) {
      c_z->data[i5] = (z->data[i5 + z->size[0] * (int32_T)t] < ZLB->data[i5]);
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = ZLB->size[0];
      i = r1->data[i5];
      b->data[i5] = ZLB->data[emlrtDynamicBoundsCheckFastR2012b(i, 1, i6,
        &l_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }
    ...
    i5 = r5->size[0];
    r5->size[0] = r3->size[0];
    emxEnsureCapacity((emxArray__common *)r5, i5, (int32_T)sizeof(int32_T),
                      &emlrtRTEI);
    loop_ub = r3->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      r5->data[i5] = r3->data[i5];
    }

    loop_ub = b->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      z->data[r5->data[i5] + z->size[0] * (int32_T)t] = b->data[i5];
    }

    /*  Identify units that crossed threshold */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:117' resp(z(:,t+1) > ZC) = true; */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    emlrtDynamicBoundsCheckFastR2012b(i6, 1, i5, &emlrtBCI, emlrtRootTLSGlobal);
    i5 = z->size[0];
    i6 = ZC->size[0];
    emlrtSizeEqCheck1DFastR2012b(i5, i6, &b_emlrtECI, emlrtRootTLSGlobal);
    emlrtPushRtStackR2012b(&c_emlrtRSI, emlrtRootTLSGlobal);
    loop_ub = z->size[0];
    i5 = b_z->size[0];
    b_z->size[0] = loop_ub;
    emxEnsureCapacity((emxArray__common *)b_z, i5, (int32_T)sizeof(boolean_T),
                      &emlrtRTEI);
    for (i5 = 0; i5 < loop_ub; i5++) {
      b_z->data[i5] = (z->data[i5 + z->size[0] * (int32_T)t] > ZC->data[i5]);
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = r1->data[i5];
      r6->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i, &m_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }

    loop_ub = r1->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      resp->data[r6->data[i5]] = TRUE;
    }

    /*  Determine time of crossing threshold */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:121' rt(resp & isinf(rt)) = T(t + 1); */
    i5 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    loop_ub = rt->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      x->data[i5] = muDoubleScalarIsInf(rt->data[i5]);
    }

    i5 = resp->size[0];
    i6 = x->size[0];
    emlrtSizeEqCheck1DFastR2012b(i5, i6, &emlrtECI, emlrtRootTLSGlobal);
    emlrtPushRtStackR2012b(&d_emlrtRSI, emlrtRootTLSGlobal);
    i5 = b_resp->size[0];
    b_resp->size[0] = resp->size[0];
    emxEnsureCapacity((emxArray__common *)b_resp, i5, (int32_T)sizeof(boolean_T),
                      &emlrtRTEI);
    loop_ub = resp->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      b_resp->data[i5] = (resp->data[i5] && x->data[i5]);
    }
    ...
    i5 = r7->size[0];
    r7->size[0] = r1->size[0];
    emxEnsureCapacity((emxArray__common *)r7, i5, (int32_T)sizeof(int32_T),
                      &emlrtRTEI);
    loop_ub = r1->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = r1->data[i5];
      r7->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i, &n_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = T->size[1];
      i = (int32_T)t + 1;
      rt->data[r7->data[i5]] = T->data[emlrtDynamicBoundsCheckFastR2012b(i, 1,
        i6, &o_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }

    /*  Break accumulation if termination criterion has been met */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:125' if any(terminate(resp)) */
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = terminate->size[0];
      i = r1->data[i5];
      x->data[i5] = terminate->data[emlrtDynamicBoundsCheckFastR2012b(i, 1, i6,
    ...
    if (!innerDimOk) {
      ...
      emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 41, m6, cv9);
      emlrtAssign(&m_y, m6);
      error(message(m_y, &i_emlrtMCI), &j_emlrtMCI);
    ...
    if (b_p) {
      ...
      emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 51, m6, cv11);
      emlrtAssign(&n_y, m6);
      error(message(n_y, &k_emlrtMCI), &l_emlrtMCI);
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cffi_irace_nomodbd_inpdepnoise:131' t = t + 1; */
      t++;
...
/* End of code generation (sam_sim_trial_cffi_irace_nomodbd_inpdepnoise.c) */
