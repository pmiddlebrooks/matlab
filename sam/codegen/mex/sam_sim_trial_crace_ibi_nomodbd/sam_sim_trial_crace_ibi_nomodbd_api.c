/*
 * sam_sim_trial_crace_ibi_nomodbd_api.c
 *
 * Code generation for function 'sam_sim_trial_crace_ibi_nomodbd_api'
 *
...
#include "sam_sim_trial_crace_ibi_nomodbd_api.h"
#include "sam_sim_trial_crace_ibi_nomodbd_emxutil.h"

/* Variable Definitions */
static emlrtRTEInfo d_emlrtRTEI = { 1, 1, "sam_sim_trial_crace_ibi_nomodbd_api",
  "" };
...
{
  info[0].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_crace_ibi_nomodbd.m";
...
void sam_sim_trial_crace_ibi_nomodbd_api(const mxArray *prhs[22], const mxArray *
  plhs[3])
{
  emxArray_real_T *u;
  emxArray_real_T *A;
  ...
  sam_sim_trial_crace_ibi_nomodbd(u, A, unusedU0, C, unusedU1, SI, Z0, ZC, ZLB,
...
/* End of code generation (sam_sim_trial_crace_ibi_nomodbd_api.c) */
