/*
 * sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.c
 *
 * Code generation for function 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise'
 *
 * C source code generated on: Wed Oct 30 11:46:55 2013
 *
 */

/* Include files */
#include "rt_nonfinite.h"
#include "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.h"
#include "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise_emxutil.h"
#include "diag.h"
#include "any.h"
#include "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 94, "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo b_emlrtRSI = { 106,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo c_emlrtRSI = { 116,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo d_emlrtRSI = { 120,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo e_emlrtRSI = { 124,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo f_emlrtRSI = { 128,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};
...
static emlrtRSInfo p_emlrtRSI = { 55, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtRSInfo q_emlrtRSI = { 21, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtRSInfo r_emlrtRSI = { 84, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };

static emlrtRSInfo s_emlrtRSI = { 89, "mtimes",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/mtimes.m" };
...
static emlrtRSInfo v_emlrtRSI = { 32, "eml_blas_xgemm",
...
static emlrtRTEInfo f_emlrtRTEI = { 106, 3,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtRTEInfo g_emlrtRTEI = { 20, 5, "eml_error",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_error.m" };

static emlrtECInfo emlrtECI = { -1, 124, 6,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtECInfo b_emlrtECI = { -1, 120, 8,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo emlrtBCI = { -1, -1, 120, 12, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo c_emlrtECI = { -1, 116, 3,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo b_emlrtBCI = { -1, -1, 116, 20, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo d_emlrtECI = { -1, 116, 5,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo c_emlrtBCI = { -1, -1, 116, 9, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo e_emlrtECI = { -1, 116, 31,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo d_emlrtBCI = { -1, -1, 116, 35, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo f_emlrtECI = { -1, 112, 3,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo e_emlrtBCI = { -1, -1, 112, 7, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo g_emlrtECI = { -1, 112, 14,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo f_emlrtBCI = { -1, -1, 112, 18, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtECInfo h_emlrtECI = { -1, 106, 10,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo g_emlrtBCI = { -1, -1, 108, 32, "u",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo h_emlrtBCI = { -1, -1, 107, 25, "u",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo i_emlrtBCI = { -1, -1, 106, 18, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo j_emlrtBCI = { -1, -1, 94, 31, "u",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtDCInfo emlrtDCI = { 94, 31,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  1 };

static emlrtECInfo i_emlrtECI = { -1, 64, 1,
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m"
};

static emlrtBCInfo k_emlrtBCI = { -1, -1, 64, 5, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo l_emlrtBCI = { -1, -1, 94, 22, "blockInput",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo m_emlrtBCI = { -1, -1, 94, 5, "u",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo n_emlrtBCI = { -1, -1, 116, 5, "z",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo o_emlrtBCI = { -1, -1, 116, 27, "ZLB",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo p_emlrtBCI = { -1, -1, 120, 3, "resp",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo q_emlrtBCI = { -1, -1, 124, 3, "rt",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo r_emlrtBCI = { -1, -1, 124, 26, "T",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo s_emlrtBCI = { -1, -1, 128, 10, "terminate",
  "sam_sim_trial_cli_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.m",
  0 };
...
static void eml_error(void)
{
  ...
  emlrtErrorWithMessageIdR2012b(emlrtRootTLSGlobal, &g_emlrtRTEI,
 ...
 *                                                          z)
 */
void sam_sim_trial_cli_ibi_nomodbd_inpdepnoise(emxArray_real_T *u, const
  ...
  *terminate, const emxArray_boolean_T *blockInput, const emxArray_boolean_T
  *unusedU2, real_T n, real_T unusedU3, real_T p, real_T t, emxArray_real_T *rt,
  emxArray_boolean_T *resp, emxArray_real_T *z)
{
  ...
  emxArray_boolean_T *b_blockInput;
  emxArray_real_T *e_z;
  emxArray_real_T *c_u;
  emxArray_real_T *f_z;
  emxArray_int32_T *r4;
  ...
  int32_T exitg3;
  const mxArray *m_y;
  static const int32_T iv30[2] = { 1, 41 };
  ...
  /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:64' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i5 = r1->size[0];
  r1->size[0] = loop_ub;
  ...
  i5 = z->size[1];
  emlrtDynamicBoundsCheckFastR2012b(1, 1, i5, &k_emlrtBCI, emlrtRootTLSGlobal);
  iv19[0] = r1->size[0];
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:70' while t < p - 1 */
  c_emxInit_real_T(&dzdt, 1, &f_emlrtRTEI, TRUE);
  ...
  b_emxInit_boolean_T(&b_blockInput, 2, &emlrtRTEI, TRUE);
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:94' u(any(blockInput(:,resp),2),t) = 0; */
    emlrtPushRtStackR2012b(&emlrtRSI, emlrtRootTLSGlobal);
    eml_li_find(resp, r1);
    loop_ub = blockInput->size[0];
    i5 = b_blockInput->size[0] * b_blockInput->size[1];
    b_blockInput->size[0] = loop_ub;
    b_blockInput->size[1] = r1->size[0];
    emxEnsureCapacity((emxArray__common *)b_blockInput, i5, (int32_T)sizeof
                      (boolean_T), &emlrtRTEI);
    b_loop_ub = r1->size[0];
    for (i5 = 0; i5 < b_loop_ub; i5++) {
      for (i6 = 0; i6 < loop_ub; i6++) {
        i7 = blockInput->size[1];
        i = r1->data[i5];
        b_blockInput->data[i6 + b_blockInput->size[0] * i5] = blockInput->
          data[i6 + blockInput->size[0] * (emlrtDynamicBoundsCheckFastR2012b(i,
          1, i7, &l_emlrtBCI, emlrtRootTLSGlobal) - 1)];
      }
    }
    ...
    emlrtDynamicBoundsCheckFastR2012b(i5, 1, i, &j_emlrtBCI, emlrtRootTLSGlobal);
    i = r1->size[0];
    for (i5 = 0; i5 < i; i5++) {
      i6 = r1->data[i5];
      u->data[(emlrtDynamicBoundsCheckFastR2012b(i6, 1, b_loop_ub, &m_emlrtBCI,
                emlrtRootTLSGlobal) + u->size[0] * ((int32_T)t - 1)) - 1] = 0.0;
    }
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:106' dzdt = A * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:107'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:108'                 SI * diag((u(:,t) ~= 0)) * randn(n,1) * sqrt(dt/tau); */
    ...
    if (!innerDimOk) {
      if (((SI->size[0] == 1) && (SI->size[1] == 1)) || ((b_b->size[0] == 1) &&
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 45, m6, cv7);
        emlrtAssign(&g_y, m6);
        error(b_message(g_y, &d_emlrtMCI), &e_emlrtMCI);
        emlrtPopRtStackR2012b(&r_emlrtRSI, emlrtRootTLSGlobal);
      } else {
        emlrtPushRtStackR2012b(&s_emlrtRSI, emlrtRootTLSGlobal);
        h_y = NULL;
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m6, cv5);
        emlrtAssign(&h_y, m6);
        error(b_message(h_y, &f_emlrtMCI), &g_emlrtMCI);
        emlrtPopRtStackR2012b(&s_emlrtRSI, emlrtRootTLSGlobal);
      }
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      ...
      for (i6 = 0; i6 < b_loop_ub; i6++) {
        ...
        i = SI->size[1];
        for (i7 = 0; i7 < i; i7++) {
          a->data[i5 + a->size[0] * i6] += SI->data[i5 + SI->size[0] * i7] *
            (real_T)b_b->data[i7 + b_b->size[0] * i6];
        }
      }
    }
    ...
    emlrtAssign(&j_y, m6);
    emlrt_marshallIn(randn(i_y, j_y, &h_emlrtMCI), "randn", b);
    ...
    if (!innerDimOk) {
      if (((a->size[0] == 1) && (a->size[1] == 1)) || (b->size[0] == 1)) {
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 45, m6, cv7);
        emlrtAssign(&k_y, m6);
        error(b_message(k_y, &d_emlrtMCI), &e_emlrtMCI);
        emlrtPopRtStackR2012b(&r_emlrtRSI, emlrtRootTLSGlobal);
      } else {
        emlrtPushRtStackR2012b(&s_emlrtRSI, emlrtRootTLSGlobal);
        l_y = NULL;
        m6 = mxCreateCharArray(2, iv27);
        for (i = 0; i < 21; i++) {
          cv5[i] = cv6[i];
        }
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m6, cv5);
        emlrtAssign(&l_y, m6);
        error(b_message(l_y, &f_emlrtMCI), &g_emlrtMCI);
        emlrtPopRtStackR2012b(&s_emlrtRSI, emlrtRootTLSGlobal);
      }
    }
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:112' z(:,t+1) = z(:,t) + dzdt; */
    i5 = z->size[1];
    i6 = (int32_T)t;
    ...
    h_z[0] = f_z->size[0];
    emlrtSubAssignSizeCheckR2012b(iv28, 1, h_z, 1, &f_emlrtECI,
      emlrtRootTLSGlobal);
    i5 = r4->size[0];
    r4->size[0] = r1->size[0];
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:116' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = z->size[0];
      i7 = r1->data[i5];
      r3->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i7, 1, i6, &n_emlrtBCI,
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = ZLB->size[0];
      i7 = r1->data[i5];
      b->data[i5] = ZLB->data[emlrtDynamicBoundsCheckFastR2012b(i7, 1, i6,
        &o_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }

    emlrtPopRtStackR2012b(&c_emlrtRSI, emlrtRootTLSGlobal);
    iv29[0] = r3->size[0];
    emlrtSubAssignSizeCheckR2012b(iv29, 1, *(int32_T (*)[1])b->size, 1,
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:120' resp(z(:,t+1) > ZC) = true; */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = r1->data[i5];
      r6->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i, &p_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:124' rt(resp & isinf(rt)) = T(t + 1); */
    i5 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = r1->data[i5];
      r7->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i, &q_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = T->size[1];
      i7 = (int32_T)t + 1;
      rt->data[r7->data[i5]] = T->data[emlrtDynamicBoundsCheckFastR2012b(i7, 1,
        i6, &r_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }

    /*  Break accumulation if termination criterion has been met */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:128' if any(terminate(resp)) */
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = terminate->size[0];
      i7 = r1->data[i5];
      x->data[i5] = terminate->data[emlrtDynamicBoundsCheckFastR2012b(i7, 1, i6,
    ...
    if (!innerDimOk) {
      ...
      emlrtAssign(&m_y, m6);
      error(b_message(m_y, &i_emlrtMCI), &j_emlrtMCI);
    ...
    if (b_p) {
      ...
      emlrtAssign(&n_y, m6);
      error(b_message(n_y, &k_emlrtMCI), &l_emlrtMCI);
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cli_ibi_nomodbd_inpdepnoise:134' t = t + 1; */
      t++;
  ...
  emxFree_real_T(&c_u);
  emxFree_real_T(&e_z);
  emxFree_boolean_T(&b_blockInput);
...
/* End of code generation (sam_sim_trial_cli_ibi_nomodbd_inpdepnoise.c) */
