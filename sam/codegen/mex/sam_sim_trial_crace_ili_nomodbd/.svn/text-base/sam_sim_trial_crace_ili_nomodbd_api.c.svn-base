 ...
 *
 * Code generation for function 'sam_sim_trial_crace_ili_nomodbd_api'
 *
...
static emlrtRTEInfo c_emlrtRTEI = { 1, 1, "sam_sim_trial_crace_ili_nomodbd_api",
  "" };
...
{
  info[0].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_crace_ili_nomodbd.m";
...
void sam_sim_trial_crace_ili_nomodbd_api(const mxArray *prhs[22], const mxArray *
  plhs[3])
{
  emxArray_real_T *u;
  emxArray_real_T *A;
  ...
  sam_sim_trial_crace_ili_nomodbd(u, A, unusedU0, C, unusedU1, SI, Z0, ZC, ZLB,
...
/* End of code generation (sam_sim_trial_crace_ili_nomodbd_api.c) */
