/*
 * sam_sim_trial_cffi_ibi_nomodbd_api.c
 *
 * Code generation for function 'sam_sim_trial_cffi_ibi_nomodbd_api'
 *
 * C source code generated on: Wed Oct 30 11:46:00 2013
 *
 */
...
#include "sam_sim_trial_cffi_ibi_nomodbd_api.h"
#include "sam_sim_trial_cffi_ibi_nomodbd_emxutil.h"

/* Variable Definitions */
static emlrtRTEInfo d_emlrtRTEI = { 1, 1, "sam_sim_trial_cffi_ibi_nomodbd_api",
  "" };
...
{
  info[0].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m";
  ...
  info[54].fileTimeLo = 1313373024U;
  info[54].fileTimeHi = 0U;
  info[54].mFileTimeLo = 0U;
  info[54].mFileTimeHi = 0U;
  info[55].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/randfun/randn.m";
  info[55].name = "eml_is_rand_extrinsic";
  info[55].dominantType = "";
  info[55].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/randfun/eml_is_rand_extrinsic.m";
  info[55].fileTimeLo = 1334096690U;
  ...
  info[56].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[56].fileTimeLo = 1343855586U;
  info[56].fileTimeHi = 0U;
  info[56].mFileTimeLo = 0U;
  info[56].mFileTimeHi = 0U;
  info[57].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[57].name = "eml_error";
  info[57].dominantType = "char";
  info[57].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  info[57].fileTimeLo = 1343855558U;
  info[57].fileTimeHi = 0U;
  info[57].mFileTimeLo = 0U;
  info[57].mFileTimeHi = 0U;
  info[58].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[58].name = "eml_scalar_sqrt";
  info[58].dominantType = "double";
  info[58].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m";
  info[58].fileTimeLo = 1286843938U;
  ...
  info[59].fileTimeLo = 1286843960U;
  ...
  info[60].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m";
  info[60].name = "any";
  info[60].dominantType = "logical";
  info[60].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/ops/any.m";
  info[60].fileTimeLo = 1286844034U;
  info[60].fileTimeHi = 0U;
  info[60].mFileTimeLo = 0U;
  info[60].mFileTimeHi = 0U;
  info[61].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  info[61].name = "isequal";
  info[61].dominantType = "double";
  info[61].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  info[61].fileTimeLo = 1286843958U;
  info[61].fileTimeHi = 0U;
  info[61].mFileTimeLo = 0U;
  info[61].mFileTimeHi = 0U;
  info[62].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  info[62].name = "eml_isequal_core";
  info[62].dominantType = "double";
  info[62].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  info[62].fileTimeLo = 1286843986U;
  info[62].fileTimeHi = 0U;
  info[62].mFileTimeLo = 0U;
  info[62].mFileTimeHi = 0U;
  info[63].context =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_all_or_any.m";
  info[63].name = "eml_const_nonsingleton_dim";
  info[63].dominantType = "logical";
  info[63].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_const_nonsingleton_dim.m";
  info[63].fileTimeLo = 1286843896U;
...
void sam_sim_trial_cffi_ibi_nomodbd_api(const mxArray *prhs[22], const mxArray
  *plhs[3])
{
  emxArray_real_T *u;
  emxArray_real_T *A;
  ...
  b_emxInit_boolean_T(&blockInput, 2, &d_emlrtRTEI, TRUE);
  ...
  sam_sim_trial_cffi_ibi_nomodbd(u, A, unusedU0, C, unusedU1, SI, Z0, ZC, ZLB,
    dt, tau, T, terminate, blockInput, unusedU2, n, unusedU3, p, t, rt, resp, z);
...
/* End of code generation (sam_sim_trial_cffi_ibi_nomodbd_api.c) */
