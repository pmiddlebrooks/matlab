/*
 * sam_sim_trial_cffi_ibi_nomodbd.c
 *
 * Code generation for function 'sam_sim_trial_cffi_ibi_nomodbd'
 *
 * C source code generated on: Wed Oct 30 11:45:59 2013
 *
 */

/* Include files */
#include "rt_nonfinite.h"
#include "sam_sim_trial_cffi_ibi_nomodbd.h"
#include "sam_sim_trial_cffi_ibi_nomodbd_emxutil.h"
#include "any.h"
#include "sam_sim_trial_cffi_ibi_nomodbd_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 94, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtRSInfo b_emlrtRSI = { 106, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtRSInfo c_emlrtRSI = { 116, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtRSInfo d_emlrtRSI = { 120, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtRSInfo e_emlrtRSI = { 124, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtRSInfo f_emlrtRSI = { 128, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };
...
static emlrtRTEInfo emlrtRTEI = { 1, 24, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtRTEInfo b_emlrtRTEI = { 20, 9, "eml_li_find",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };

static emlrtRTEInfo e_emlrtRTEI = { 106, 3, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtRTEInfo f_emlrtRTEI = { 20, 5, "eml_error",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_error.m" };

static emlrtECInfo emlrtECI = { -1, 124, 6, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtECInfo b_emlrtECI = { -1, 120, 8, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtBCInfo emlrtBCI = { -1, -1, 120, 12, "z",
  "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m", 0 };

static emlrtECInfo c_emlrtECI = { -1, 116, 3, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };
...
static emlrtECInfo d_emlrtECI = { -1, 116, 5, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };
...
static emlrtECInfo e_emlrtECI = { -1, 116, 31, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };
...
static emlrtECInfo f_emlrtECI = { -1, 112, 3, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };
...
static emlrtECInfo g_emlrtECI = { -1, 112, 14, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };
...
static emlrtECInfo h_emlrtECI = { -1, 106, 10, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };

static emlrtBCInfo g_emlrtBCI = { -1, -1, 107, 25, "u",
  "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m", 0 };

static emlrtBCInfo h_emlrtBCI = { -1, -1, 106, 18, "z",
  "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m", 0 };

static emlrtBCInfo i_emlrtBCI = { -1, -1, 94, 31, "u",
  "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m", 0 };

static emlrtDCInfo emlrtDCI = { 94, 31, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m", 1 };

static emlrtECInfo i_emlrtECI = { -1, 64, 1, "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m" };
...
static emlrtBCInfo k_emlrtBCI = { -1, -1, 94, 22, "blockInput",
  "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m", 0 };

static emlrtBCInfo l_emlrtBCI = { -1, -1, 94, 5, "u",
  "sam_sim_trial_cffi_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd.m", 0 };
 ...
 *                                                          z)
 */
void sam_sim_trial_cffi_ibi_nomodbd(emxArray_real_T *u, const emxArray_real_T *A,
  const emxArray_real_T *unusedU0, const emxArray_real_T *C, const
  emxArray_real_T *unusedU1, const emxArray_real_T *SI, const emxArray_real_T
  *Z0, const emxArray_real_T *ZC, const emxArray_real_T *ZLB, real_T dt, real_T
  tau, const emxArray_real_T *T, const emxArray_boolean_T *terminate, const
  emxArray_boolean_T *blockInput, const emxArray_boolean_T *unusedU2, real_T n,
  real_T unusedU3, real_T p, real_T t, emxArray_real_T *rt, emxArray_boolean_T
  *resp, emxArray_real_T *z)
{
  emxArray_int32_T *r1;
  int32_T loop_ub;
  int32_T i4;
  ...
  /* 'sam_sim_trial_cffi_ibi_nomodbd:64' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i4 = r1->size[0];
  r1->size[0] = loop_ub;
  ...
  i4 = z->size[1];
  emlrtDynamicBoundsCheckFastR2012b(1, 1, i4, &j_emlrtBCI, emlrtRootTLSGlobal);
  iv19[0] = r1->size[0];
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cffi_ibi_nomodbd:70' while t < p - 1 */
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:94' u(any(blockInput(:,resp),2),t) = 0; */
    emlrtPushRtStackR2012b(&emlrtRSI, emlrtRootTLSGlobal);
    eml_li_find(resp, r1);
    loop_ub = blockInput->size[0];
    i4 = b_blockInput->size[0] * b_blockInput->size[1];
    b_blockInput->size[0] = loop_ub;
    b_blockInput->size[1] = r1->size[0];
    emxEnsureCapacity((emxArray__common *)b_blockInput, i4, (int32_T)sizeof
                      (boolean_T), &emlrtRTEI);
    i = r1->size[0];
    for (i4 = 0; i4 < i; i4++) {
      for (i5 = 0; i5 < loop_ub; i5++) {
        c_u = blockInput->size[1];
        i6 = r1->data[i4];
        b_blockInput->data[i5 + b_blockInput->size[0] * i4] = blockInput->
          data[i5 + blockInput->size[0] * (emlrtDynamicBoundsCheckFastR2012b(i6,
          1, c_u, &k_emlrtBCI, emlrtRootTLSGlobal) - 1)];
      }
    }
    ...
    c_u = u->size[0];
    i = u->size[1];
    i4 = (int32_T)emlrtIntegerCheckFastR2012b(t, &emlrtDCI, emlrtRootTLSGlobal);
    emlrtDynamicBoundsCheckFastR2012b(i4, 1, i, &i_emlrtBCI, emlrtRootTLSGlobal);
    i = r1->size[0];
    for (i4 = 0; i4 < i; i4++) {
      i5 = r1->data[i4];
      u->data[(emlrtDynamicBoundsCheckFastR2012b(i5, 1, c_u, &l_emlrtBCI,
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:106' dzdt = A * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:107'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:108'                 SI * randn(n,1) * sqrt(dt/tau); */
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:112' z(:,t+1) = z(:,t) + dzdt; */
    i4 = z->size[1];
    i5 = (int32_T)t;
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:116' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = z->size[0];
      c_u = r1->data[i4];
      r3->data[i4] = emlrtDynamicBoundsCheckFastR2012b(c_u, 1, i5, &m_emlrtBCI,
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = ZLB->size[0];
      c_u = r1->data[i4];
      b->data[i4] = ZLB->data[emlrtDynamicBoundsCheckFastR2012b(c_u, 1, i5,
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:120' resp(z(:,t+1) > ZC) = true; */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = r1->data[i4];
      r6->data[i4] = emlrtDynamicBoundsCheckFastR2012b(i5, 1, i, &o_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:124' rt(resp & isinf(rt)) = T(t + 1); */
    i4 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = r1->data[i4];
      r7->data[i4] = emlrtDynamicBoundsCheckFastR2012b(i5, 1, i, &p_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = T->size[1];
      c_u = (int32_T)t + 1;
      rt->data[r7->data[i4]] = T->data[emlrtDynamicBoundsCheckFastR2012b(c_u, 1,
        i5, &q_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }

    /*  Break accumulation if termination criterion has been met */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd:128' if any(terminate(resp)) */
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = terminate->size[0];
      c_u = r1->data[i4];
      x->data[i4] = terminate->data[emlrtDynamicBoundsCheckFastR2012b(c_u, 1, i5,
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cffi_ibi_nomodbd:134' t = t + 1; */
      t++;
...
/* End of code generation (sam_sim_trial_cffi_ibi_nomodbd.c) */
