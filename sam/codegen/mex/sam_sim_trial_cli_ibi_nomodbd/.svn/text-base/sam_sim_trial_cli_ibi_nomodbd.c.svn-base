/*
 * sam_sim_trial_cli_ibi_nomodbd.c
 *
...
#include "sam_sim_trial_cli_ibi_nomodbd.h"
#include "sam_sim_trial_cli_ibi_nomodbd_emxutil.h"
#include "any.h"
#include "sam_sim_trial_cli_ibi_nomodbd_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 94, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtRSInfo b_emlrtRSI = { 106, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtRSInfo c_emlrtRSI = { 116, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtRSInfo d_emlrtRSI = { 120, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtRSInfo e_emlrtRSI = { 124, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtRSInfo f_emlrtRSI = { 128, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
...
static emlrtRTEInfo emlrtRTEI = { 1, 24, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtRTEInfo b_emlrtRTEI = { 20, 9, "eml_li_find",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };

static emlrtRTEInfo e_emlrtRTEI = { 106, 3, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtRTEInfo f_emlrtRTEI = { 20, 5, "eml_error",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_error.m" };

static emlrtECInfo emlrtECI = { -1, 124, 6, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtECInfo b_emlrtECI = { -1, 120, 8, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };

static emlrtBCInfo emlrtBCI = { -1, -1, 120, 12, "z",
  "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m", 0 };

static emlrtECInfo c_emlrtECI = { -1, 116, 3, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
...
static emlrtECInfo d_emlrtECI = { -1, 116, 5, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
...
static emlrtECInfo e_emlrtECI = { -1, 116, 31, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
...
static emlrtECInfo f_emlrtECI = { -1, 112, 3, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
...
static emlrtECInfo g_emlrtECI = { -1, 112, 14, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
...
static emlrtECInfo h_emlrtECI = { -1, 106, 10, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
...
static emlrtDCInfo emlrtDCI = { 94, 31, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m", 1 };

static emlrtECInfo i_emlrtECI = { -1, 64, 1, "sam_sim_trial_cli_ibi_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_ibi_nomodbd.m" };
 ...
 *                                                          z)
 */
void sam_sim_trial_cli_ibi_nomodbd(emxArray_real_T *u, const emxArray_real_T *A,
  ...
  *resp, emxArray_real_T *z)
{
  ...
  /* 'sam_sim_trial_cli_ibi_nomodbd:64' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i4 = r1->size[0];
  r1->size[0] = loop_ub;
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cli_ibi_nomodbd:70' while t < p - 1 */
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd:94' u(any(blockInput(:,resp),2),t) = 0; */
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cli_ibi_nomodbd:106' dzdt = A * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cli_ibi_nomodbd:107'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cli_ibi_nomodbd:108'                 SI * randn(n,1) * sqrt(dt/tau); */
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd:112' z(:,t+1) = z(:,t) + dzdt; */
    i4 = z->size[1];
    i5 = (int32_T)t;
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd:116' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd:120' resp(z(:,t+1) > ZC) = true; */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd:124' rt(resp & isinf(rt)) = T(t + 1); */
    i4 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_ibi_nomodbd:128' if any(terminate(resp)) */
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cli_ibi_nomodbd:134' t = t + 1; */
      t++;
...
/* End of code generation (sam_sim_trial_cli_ibi_nomodbd.c) */
