/*
 * sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise.c
 *
 * Code generation for function 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise'
 *
...
#include "diag.h"
#include "any.h"
#include "sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 94, "sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo b_emlrtRSI = { 106,
  "sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise.m"
};
 ...
 *                                                          z)
 */
void sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise(emxArray_real_T *u, const
  ...
  emxArray_boolean_T *resp, emxArray_real_T *z)
{
  ...
  /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:64' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i5 = r1->size[0];
  r1->size[0] = loop_ub;
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:70' while t < p - 1 */
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:94' u(any(blockInput(:,resp),2),t) = 0; */
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:106' dzdt = A * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:107'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:108'                 SI * diag((u(:,t) ~= 0)) * randn(n,1) * sqrt(dt/tau); */
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:112' z(:,t+1) = z(:,t) + dzdt; */
    i5 = z->size[1];
    i6 = (int32_T)t;
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:116' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:120' resp(z(:,t+1) > ZC) = true; */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:124' rt(resp & isinf(rt)) = T(t + 1); */
    i5 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:128' if any(terminate(resp)) */
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise:134' t = t + 1; */
      t++;
...
/* End of code generation (sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise.c) */
