/*
 * sam_sim_trial_cffi_ibi_nomodbd_inpdepnoise.h
 *
...
#ifndef __SAM_SIM_TRIAL_CFFI_IBI_NOMODBD_INPDEPNOISE_H__
#define __SAM_SIM_TRIAL_CFFI_IBI_NOMODBD_INPDEPNOISE_H__
/* Include files */
#include <math.h>
#include <stdlib.h>
#include <string.h>
