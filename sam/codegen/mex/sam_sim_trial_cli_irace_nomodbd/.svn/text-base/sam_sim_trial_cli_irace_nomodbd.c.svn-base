/*
 * sam_sim_trial_cli_irace_nomodbd.c
 *
 * Code generation for function 'sam_sim_trial_cli_irace_nomodbd'
 *
 * C source code generated on: Wed Oct 30 11:46:09 2013
 *
 */

/* Include files */
#include "rt_nonfinite.h"
#include "sam_sim_trial_cli_irace_nomodbd.h"
#include "sam_sim_trial_cli_irace_nomodbd_emxutil.h"
#include "sam_sim_trial_cli_irace_nomodbd_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 103, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtRSInfo b_emlrtRSI = { 113, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtRSInfo c_emlrtRSI = { 117, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtRSInfo d_emlrtRSI = { 121, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtRSInfo e_emlrtRSI = { 125, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };
...
static emlrtRSInfo ob_emlrtRSI = { 12, "any",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/ops/any.m" };

static emlrtRSInfo pb_emlrtRSI = { 24, "eml_all_or_any",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_all_or_any.m"
};

static emlrtRSInfo qb_emlrtRSI = { 27, "eml_all_or_any",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_all_or_any.m"
};

static emlrtRSInfo rb_emlrtRSI = { 109, "eml_all_or_any",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_all_or_any.m"
};
...
static emlrtRTEInfo emlrtRTEI = { 1, 24, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtRTEInfo b_emlrtRTEI = { 20, 9, "eml_li_find",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };

static emlrtRTEInfo d_emlrtRTEI = { 103, 3, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtRTEInfo e_emlrtRTEI = { 20, 5, "eml_error",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_error.m" };

static emlrtECInfo emlrtECI = { -1, 121, 6, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtECInfo b_emlrtECI = { -1, 117, 8, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtBCInfo emlrtBCI = { -1, -1, 117, 12, "z",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtECInfo c_emlrtECI = { -1, 113, 3, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };
...
static emlrtECInfo d_emlrtECI = { -1, 113, 5, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };
...
static emlrtECInfo e_emlrtECI = { -1, 113, 31, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };
...
static emlrtECInfo f_emlrtECI = { -1, 109, 3, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };
...
static emlrtECInfo g_emlrtECI = { -1, 109, 14, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };
...
static emlrtECInfo h_emlrtECI = { -1, 103, 10, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtBCInfo g_emlrtBCI = { -1, -1, 104, 25, "u",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtBCInfo h_emlrtBCI = { -1, -1, 103, 18, "z",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtDCInfo emlrtDCI = { 103, 18, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 1 };

static emlrtECInfo i_emlrtECI = { -1, 61, 1, "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m" };

static emlrtBCInfo i_emlrtBCI = { -1, -1, 61, 5, "z",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtBCInfo j_emlrtBCI = { -1, -1, 113, 5, "z",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtBCInfo k_emlrtBCI = { -1, -1, 113, 27, "ZLB",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtBCInfo l_emlrtBCI = { -1, -1, 117, 3, "resp",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtBCInfo m_emlrtBCI = { -1, -1, 121, 3, "rt",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtBCInfo n_emlrtBCI = { -1, -1, 121, 26, "T",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };

static emlrtBCInfo o_emlrtBCI = { -1, -1, 125, 10, "terminate",
  "sam_sim_trial_cli_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cli_irace_nomodbd.m", 0 };
...
static void eml_error(void)
{
  ...
  emlrtErrorWithMessageIdR2012b(emlrtRootTLSGlobal, &e_emlrtRTEI,
 ...
 *                                                          z)
 */
void sam_sim_trial_cli_irace_nomodbd(const emxArray_real_T *u, const
  ...
  *unusedU3, real_T n, real_T unusedU4, real_T p, real_T t, emxArray_real_T *rt,
  emxArray_boolean_T *resp, emxArray_real_T *z)
{
  ...
  int32_T exitg3;
  const mxArray *k_y;
  static const int32_T iv26[2] = { 1, 41 };
  ...
  /* 'sam_sim_trial_cli_irace_nomodbd:61' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i4 = r1->size[0];
  r1->size[0] = loop_ub;
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cli_irace_nomodbd:67' while t < p - 1 */
  c_emxInit_real_T(&dzdt, 1, &d_emlrtRTEI, TRUE);
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cli_irace_nomodbd:103' dzdt = A * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cli_irace_nomodbd:104'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cli_irace_nomodbd:105'                 SI * randn(n,1) * sqrt(dt/tau); */
    ...
    if (guard3 == TRUE) {
      ...
      for (i4 = 0; i4 < loop_ub; i4++) {
        ...
        i = A->size[1];
        for (i5 = 0; i5 < i; i5++) {
          dzdt->data[i4] += A->data[i4 + A->size[0] * i5] * e_z->data[i5];
        }
      }
    }
    ...
    emlrtAssign(&h_y, m6);
    emlrt_marshallIn(randn(g_y, h_y, &g_emlrtMCI), "randn", b);
    ...
    if (!innerDimOk) {
      if (((SI->size[0] == 1) && (SI->size[1] == 1)) || (b->size[0] == 1)) {
        ...
        emlrtInitCharArrayR2013a(emlrtRootTLSGlobal, 21, m6, cv5);
        emlrtAssign(&j_y, m6);
        error(message(j_y, &c_emlrtMCI), &d_emlrtMCI);
        emlrtPopRtStackR2012b(&i_emlrtRSI, emlrtRootTLSGlobal);
      }
    }
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_irace_nomodbd:109' z(:,t+1) = z(:,t) + dzdt; */
    i4 = z->size[1];
    i5 = (int32_T)t;
    ...
    h_z[0] = f_z->size[0];
    emlrtSubAssignSizeCheckR2012b(iv24, 1, h_z, 1, &f_emlrtECI,
      emlrtRootTLSGlobal);
    i4 = r4->size[0];
    r4->size[0] = r1->size[0];
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_irace_nomodbd:113' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = z->size[0];
      i = r1->data[i4];
      r3->data[i4] = emlrtDynamicBoundsCheckFastR2012b(i, 1, i5, &j_emlrtBCI,
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = ZLB->size[0];
      i = r1->data[i4];
      b->data[i4] = ZLB->data[emlrtDynamicBoundsCheckFastR2012b(i, 1, i5,
        &k_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }

    emlrtPopRtStackR2012b(&b_emlrtRSI, emlrtRootTLSGlobal);
    iv25[0] = r3->size[0];
    emlrtSubAssignSizeCheckR2012b(iv25, 1, *(int32_T (*)[1])b->size, 1,
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_irace_nomodbd:117' resp(z(:,t+1) > ZC) = true; */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = r1->data[i4];
      r6->data[i4] = emlrtDynamicBoundsCheckFastR2012b(i5, 1, i, &l_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_irace_nomodbd:121' rt(resp & isinf(rt)) = T(t + 1); */
    i4 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = r1->data[i4];
      r7->data[i4] = emlrtDynamicBoundsCheckFastR2012b(i5, 1, i, &m_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = T->size[1];
      i = (int32_T)t + 1;
      rt->data[r7->data[i4]] = T->data[emlrtDynamicBoundsCheckFastR2012b(i, 1,
        i5, &n_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }

    /*  Break accumulation if termination criterion has been met */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cli_irace_nomodbd:125' if any(terminate(resp)) */
    ...
    for (i4 = 0; i4 < loop_ub; i4++) {
      i5 = terminate->size[0];
      i = r1->data[i4];
      x->data[i4] = terminate->data[emlrtDynamicBoundsCheckFastR2012b(i, 1, i5,
    ...
    if (!innerDimOk) {
      ...
      emlrtAssign(&k_y, m6);
      error(message(k_y, &i_emlrtMCI), &j_emlrtMCI);
    ...
    if (b_p) {
      ...
      emlrtAssign(&l_y, m6);
      error(message(l_y, &k_emlrtMCI), &l_emlrtMCI);
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cli_irace_nomodbd:131' t = t + 1; */
      t++;
...
/* End of code generation (sam_sim_trial_cli_irace_nomodbd.c) */
