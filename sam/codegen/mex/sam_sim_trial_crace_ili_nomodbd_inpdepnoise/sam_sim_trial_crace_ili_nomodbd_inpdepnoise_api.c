/*
 * sam_sim_trial_crace_ili_nomodbd_inpdepnoise_api.c
 *
 * Code generation for function 'sam_sim_trial_crace_ili_nomodbd_inpdepnoise_api'
 *
...
#include "sam_sim_trial_crace_ili_nomodbd_inpdepnoise_api.h"
#include "sam_sim_trial_crace_ili_nomodbd_inpdepnoise_emxutil.h"

/* Variable Definitions */
static emlrtRTEInfo d_emlrtRTEI = { 1, 1,
  "sam_sim_trial_crace_ili_nomodbd_inpdepnoise_api", "" };
...
{
  info[0].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_crace_ili_nomodbd_inpdepnoise.m";
  ...
  info[31].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_crace_ili_nomodbd_inpdepnoise.m";
  info[31].name = "diag";
  info[31].dominantType = "logical";
  info[31].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  info[31].fileTimeLo = 1286843886U;
  info[31].fileTimeHi = 0U;
  info[31].mFileTimeLo = 0U;
  info[31].mFileTimeHi = 0U;
  info[32].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  info[32].name = "eml_index_class";
  info[32].dominantType = "";
  info[32].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[32].fileTimeLo = 1323195778U;
  info[32].fileTimeHi = 0U;
  info[32].mFileTimeLo = 0U;
  info[32].mFileTimeHi = 0U;
  info[33].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  info[33].name = "eml_index_plus";
  info[33].dominantType = "coder.internal.indexInt";
  info[33].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[33].fileTimeLo = 1286843978U;
  info[33].fileTimeHi = 0U;
  info[33].mFileTimeLo = 0U;
  info[33].mFileTimeHi = 0U;
  info[34].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  info[34].name = "eml_scalar_eg";
  info[34].dominantType = "logical";
  info[34].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_scalar_eg.m";
  info[34].fileTimeLo = 1286843996U;
  info[34].fileTimeHi = 0U;
  info[34].mFileTimeLo = 0U;
  info[34].mFileTimeHi = 0U;
  info[35].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elmat/diag.m";
  info[35].name = "eml_int_forloop_overflow_check";
  info[35].dominantType = "";
  info[35].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[35].fileTimeLo = 1346535540U;
  ...
  info[36].fileTimeLo = 1313373024U;
  info[36].fileTimeHi = 0U;
  info[36].mFileTimeLo = 0U;
  info[36].mFileTimeHi = 0U;
  info[37].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/randfun/randn.m";
  info[37].name = "eml_is_rand_extrinsic";
  info[37].dominantType = "";
  info[37].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/randfun/eml_is_rand_extrinsic.m";
  info[37].fileTimeLo = 1334096690U;
  ...
  info[38].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[38].fileTimeLo = 1343855586U;
  info[38].fileTimeHi = 0U;
  info[38].mFileTimeLo = 0U;
  info[38].mFileTimeHi = 0U;
  info[39].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[39].name = "eml_error";
  info[39].dominantType = "char";
  info[39].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  info[39].fileTimeLo = 1343855558U;
  info[39].fileTimeHi = 0U;
  info[39].mFileTimeLo = 0U;
  info[39].mFileTimeHi = 0U;
  info[40].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[40].name = "eml_scalar_sqrt";
  info[40].dominantType = "double";
  info[40].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m";
  info[40].fileTimeLo = 1286843938U;
...
void sam_sim_trial_crace_ili_nomodbd_inpdepnoise_api(const mxArray *prhs[22],
  const mxArray *plhs[3])
{
  ...
  b_emxInit_boolean_T(&latInhib, 2, &d_emlrtRTEI, TRUE);
  ...
  sam_sim_trial_crace_ili_nomodbd_inpdepnoise(u, A, unusedU0, C, unusedU1, SI,
    Z0, ZC, ZLB, dt, tau, T, terminate, unusedU2, latInhib, n, unusedU3, p, t,
    rt, resp, z);
...
/* End of code generation (sam_sim_trial_crace_ili_nomodbd_inpdepnoise_api.c) */
