/*
 * sam_sim_trial_cffi_irace_nomodbd.c
 *
 * Code generation for function 'sam_sim_trial_cffi_irace_nomodbd'
 *
 * C source code generated on: Wed Oct 30 11:45:55 2013
 *
 */

/* Include files */
#include "rt_nonfinite.h"
#include "sam_sim_trial_cffi_irace_nomodbd.h"
#include "sam_sim_trial_cffi_irace_nomodbd_emxutil.h"
#include "sam_sim_trial_cffi_irace_nomodbd_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 103, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtRSInfo b_emlrtRSI = { 113, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtRSInfo c_emlrtRSI = { 117, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtRSInfo d_emlrtRSI = { 121, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtRSInfo e_emlrtRSI = { 125, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };
...
static emlrtRTEInfo emlrtRTEI = { 1, 24, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtRTEInfo b_emlrtRTEI = { 20, 9, "eml_li_find",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_li_find.m" };

static emlrtRTEInfo d_emlrtRTEI = { 103, 3, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtRTEInfo e_emlrtRTEI = { 20, 5, "eml_error",
  "/Applications/MATLAB_R2013a.app/toolbox/eml/lib/matlab/eml/eml_error.m" };

static emlrtECInfo emlrtECI = { -1, 121, 6, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtECInfo b_emlrtECI = { -1, 117, 8, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };

static emlrtBCInfo emlrtBCI = { -1, -1, 117, 12, "z",
  "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m", 0 };

static emlrtECInfo c_emlrtECI = { -1, 113, 3, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };
...
static emlrtECInfo d_emlrtECI = { -1, 113, 5, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };
...
static emlrtECInfo f_emlrtECI = { -1, 109, 3, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };
...
static emlrtDCInfo emlrtDCI = { 103, 18, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m", 1 };

static emlrtECInfo i_emlrtECI = { -1, 61, 1, "sam_sim_trial_cffi_irace_nomodbd",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m" };
 ...
 *                                                          z)
 */
void sam_sim_trial_cffi_irace_nomodbd(const emxArray_real_T *u, const
  ...
  emxArray_boolean_T *resp, emxArray_real_T *z)
{
  ...
  /* 'sam_sim_trial_cffi_irace_nomodbd:61' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i4 = r1->size[0];
  r1->size[0] = loop_ub;
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cffi_irace_nomodbd:67' while t < p - 1 */
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cffi_irace_nomodbd:103' dzdt = A * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cffi_irace_nomodbd:104'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cffi_irace_nomodbd:105'                 SI * randn(n,1) * sqrt(dt/tau); */
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd:109' z(:,t+1) = z(:,t) + dzdt; */
    i4 = z->size[1];
    i5 = (int32_T)t;
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd:113' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd:117' resp(z(:,t+1) > ZC) = true; */
    i4 = z->size[1];
    i5 = (int32_T)(t + 1.0);
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd:121' rt(resp & isinf(rt)) = T(t + 1); */
    i4 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_irace_nomodbd:125' if any(terminate(resp)) */
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cffi_irace_nomodbd:131' t = t + 1; */
      t++;
...
/* End of code generation (sam_sim_trial_cffi_irace_nomodbd.c) */
