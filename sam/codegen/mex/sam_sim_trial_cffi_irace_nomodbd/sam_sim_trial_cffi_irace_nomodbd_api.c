/*
 * sam_sim_trial_cffi_irace_nomodbd_api.c
 *
 * Code generation for function 'sam_sim_trial_cffi_irace_nomodbd_api'
 *
...
#include "sam_sim_trial_cffi_irace_nomodbd_api.h"
#include "sam_sim_trial_cffi_irace_nomodbd_emxutil.h"

/* Variable Definitions */
static emlrtRTEInfo c_emlrtRTEI = { 1, 1, "sam_sim_trial_cffi_irace_nomodbd_api",
  "" };
...
{
  info[0].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m";
  info[0].name = "mtimes";
  ...
  info[26].resolved = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[26].fileTimeLo = 1343855586U;
  info[26].fileTimeHi = 0U;
  info[26].mFileTimeLo = 0U;
  info[26].mFileTimeHi = 0U;
  info[27].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[27].name = "eml_error";
  info[27].dominantType = "char";
  info[27].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_error.m";
  info[27].fileTimeLo = 1343855558U;
  info[27].fileTimeHi = 0U;
  info[27].mFileTimeLo = 0U;
  info[27].mFileTimeHi = 0U;
  info[28].context = "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/sqrt.m";
  info[28].name = "eml_scalar_sqrt";
  info[28].dominantType = "double";
  info[28].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_sqrt.m";
  info[28].fileTimeLo = 1286843938U;
  info[28].fileTimeHi = 0U;
  info[28].mFileTimeLo = 0U;
  info[28].mFileTimeHi = 0U;
  info[29].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_irace_nomodbd.m";
  info[29].name = "eml_li_find";
  info[29].dominantType = "";
  info[29].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_li_find.m";
  info[29].fileTimeLo = 1286843986U;
  ...
  info[30].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_class.m";
  info[30].fileTimeLo = 1323195778U;
  ...
  info[32].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[32].fileTimeLo = 1346535540U;
  ...
  info[34].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_int_forloop_overflow_check.m";
  info[34].fileTimeLo = 1346535540U;
  ...
  info[35].resolved =
    "[ILXE]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_index_plus.m";
  info[35].fileTimeLo = 1286843978U;
...
void sam_sim_trial_cffi_irace_nomodbd_api(const mxArray *prhs[22], const mxArray
  *plhs[3])
{
  emxArray_real_T *u;
  emxArray_real_T *A;
  ...
  sam_sim_trial_cffi_irace_nomodbd(u, A, unusedU0, C, unusedU1, SI, Z0, ZC, ZLB,
    dt, tau, T, terminate, unusedU2, unusedU2, n, unusedU4, p, t, rt, resp, z);
...
/* End of code generation (sam_sim_trial_cffi_irace_nomodbd_api.c) */
