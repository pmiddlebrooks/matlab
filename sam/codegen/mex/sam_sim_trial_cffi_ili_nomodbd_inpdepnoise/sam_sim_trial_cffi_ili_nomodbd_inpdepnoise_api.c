/*
 * sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_api.c
 *
 * Code generation for function 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_api'
 *
...
#include "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_api.h"
#include "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_emxutil.h"

/* Variable Definitions */
static emlrtRTEInfo d_emlrtRTEI = { 1, 1,
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_api", "" };
...
{
  info[0].context =
    "[E]/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m";
...
void sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_api(const mxArray *prhs[22],
  const mxArray *plhs[3])
{
  ...
  sam_sim_trial_cffi_ili_nomodbd_inpdepnoise(u, A, unusedU0, C, unusedU1, SI, Z0,
    ZC, ZLB, dt, tau, T, terminate, unusedU2, latInhib, n, unusedU3, p, t, rt,
    resp, z);
...
/* End of code generation (sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_api.c) */
