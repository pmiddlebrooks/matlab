/*
 * sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.c
 *
 * Code generation for function 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise'
 *
 * C source code generated on: Wed Oct 30 11:46:46 2013
 *
 */

/* Include files */
#include "rt_nonfinite.h"
#include "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.h"
#include "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_emxutil.h"
#include "diag.h"
#include "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise_data.h"

/* Variable Definitions */
static emlrtRSInfo emlrtRSI = { 98, "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m"
};

static emlrtRSInfo b_emlrtRSI = { 106,
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m"
};
...
static emlrtRTEInfo e_emlrtRTEI = { 76, 3,
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m"
};
...
static emlrtBCInfo i_emlrtBCI = { -1, -1, 106, 19, "z",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtDCInfo emlrtDCI = { 106, 19,
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  1 };
...
static emlrtBCInfo j_emlrtBCI = { -1, -1, 64, 5, "z",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo k_emlrtBCI = { -1, -1, 98, 17, "latInhib",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo l_emlrtBCI = { -1, -1, 98, 3, "At",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo m_emlrtBCI = { -1, -1, 116, 5, "z",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo n_emlrtBCI = { -1, -1, 116, 27, "ZLB",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo o_emlrtBCI = { -1, -1, 120, 3, "resp",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo p_emlrtBCI = { -1, -1, 124, 3, "rt",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo q_emlrtBCI = { -1, -1, 124, 26, "T",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };

static emlrtBCInfo r_emlrtBCI = { -1, -1, 128, 10, "terminate",
  "sam_sim_trial_cffi_ili_nomodbd_inpdepnoise",
  "/Users/paulmiddlebrooks/matlab/sam/sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.m",
  0 };
 ...
 *                                                          z)
 */
void sam_sim_trial_cffi_ili_nomodbd_inpdepnoise(const emxArray_real_T *u, const
  ...
  emxArray_boolean_T *resp, emxArray_real_T *z)
{
  ...
  /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:64' z(:,1) = Z0; */
  loop_ub = z->size[0];
  i5 = r1->size[0];
  r1->size[0] = loop_ub;
  ...
  /*  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% */
  /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:70' while t < p - 1 */
  emxInit_real_T(&At, 2, &e_emlrtRTEI, TRUE);
  ...
  while ((exitg1 == FALSE) && (t < p - 1.0)) {
    ...
    /*  threshold) */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:76' At = A; */
    i5 = At->size[0] * At->size[1];
    At->size[0] = A->size[0];
    At->size[1] = A->size[1];
    emxEnsureCapacity((emxArray__common *)At, i5, (int32_T)sizeof(real_T),
                      &emlrtRTEI);
    loop_ub = A->size[0] * A->size[1];
    for (i5 = 0; i5 < loop_ub; i5++) {
      At->data[i5] = A->data[i5];
    }
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:98' At(latInhib(:,~resp)) = 0; */
    emlrtPushRtStackR2012b(&emlrtRSI, emlrtRootTLSGlobal);
    i5 = c_resp->size[0];
    c_resp->size[0] = resp->size[0];
    emxEnsureCapacity((emxArray__common *)c_resp, i5, (int32_T)sizeof(boolean_T),
                      &emlrtRTEI);
    loop_ub = resp->size[0];
    for (i5 = 0; i5 < loop_ub; i5++) {
      c_resp->data[i5] = !resp->data[i5];
    }

    eml_li_find(c_resp, r1);
    loop_ub = latInhib->size[0];
    i5 = b_latInhib->size[0] * b_latInhib->size[1];
    b_latInhib->size[0] = loop_ub;
    b_latInhib->size[1] = r1->size[0];
    emxEnsureCapacity((emxArray__common *)b_latInhib, i5, (int32_T)sizeof
                      (boolean_T), &emlrtRTEI);
    b_loop_ub = r1->size[0];
    for (i5 = 0; i5 < b_loop_ub; i5++) {
      for (i6 = 0; i6 < loop_ub; i6++) {
        i7 = latInhib->size[1];
        i = r1->data[i5];
        b_latInhib->data[i6 + b_latInhib->size[0] * i5] = latInhib->data[i6 +
          latInhib->size[0] * (emlrtDynamicBoundsCheckFastR2012b(i, 1, i7,
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      ...
      i7 = r1->data[i5];
      At->data[emlrtDynamicBoundsCheckFastR2012b(i7, 1, i6, &l_emlrtBCI,
    ...
    /*  % Inputs */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:106' dzdt = At * z(:,t) * dt/tau + ... % Endogenous connectivity */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:107'                 C * u(:,t) * dt/tau + ... % Inputs */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:108'                 SI * diag((u(:,t) ~= 0)) * randn(n,1) * sqrt(dt/tau); */
    ...
    if (guard3 == TRUE) {
      ...
      for (i5 = 0; i5 < loop_ub; i5++) {
        ...
        for (i6 = 0; i6 < b_loop_ub; i6++) {
          dzdt->data[i5] += At->data[i5 + At->size[0] * i6] * e_z->data[i6];
        }
      }
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      ...
      for (i6 = 0; i6 < b_loop_ub; i6++) {
        At->data[i5 + At->size[0] * i6] = 0.0;
        i = SI->size[1];
        for (i7 = 0; i7 < i; i7++) {
          At->data[i5 + At->size[0] * i6] += SI->data[i5 + SI->size[0] * i7] *
    ...
    emlrtPushRtStackR2012b(&n_emlrtRSI, emlrtRootTLSGlobal);
    innerDimOk = (At->size[1] == b->size[0]);
    if (!innerDimOk) {
      if (((At->size[0] == 1) && (At->size[1] == 1)) || (b->size[0] == 1)) {
        emlrtPushRtStackR2012b(&o_emlrtRSI, emlrtRootTLSGlobal);
        k_y = NULL;
    ...
    emlrtPopRtStackR2012b(&n_emlrtRSI, emlrtRootTLSGlobal);
    if ((At->size[1] == 1) || (b->size[0] == 1)) {
      i5 = b_y->size[0];
      b_y->size[0] = At->size[0];
      ...
      for (i5 = 0; i5 < loop_ub; i5++) {
        ...
        b_loop_ub = At->size[1];
        for (i6 = 0; i6 < b_loop_ub; i6++) {
          b_y->data[i5] += At->data[i5 + At->size[0] * i6] * b->data[i6];
        }
      }
    } else {
      unnamed_idx_0 = (int8_T)At->size[0];
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:112' z(:,t+1) = z(:,t) + dzdt; */
    i5 = z->size[1];
    i6 = (int32_T)t;
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:116' z(z(:,t+1) < ZLB,t+1) = ZLB(z(:,t+1) < ZLB); */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = z->size[0];
      i7 = r1->data[i5];
      r3->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i7, 1, i6, &m_emlrtBCI,
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:120' resp(z(:,t+1) > ZC) = true; */
    i5 = z->size[1];
    i6 = (int32_T)(t + 1.0);
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = r1->data[i5];
      r6->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i, &o_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:124' rt(resp & isinf(rt)) = T(t + 1); */
    i5 = x->size[0];
    x->size[0] = rt->size[0];
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      i6 = r1->data[i5];
      r7->data[i5] = emlrtDynamicBoundsCheckFastR2012b(i6, 1, i, &p_emlrtBCI,
        emlrtRootTLSGlobal) - 1;
    }
    ...
    for (i5 = 0; i5 < loop_ub; i5++) {
      ...
      rt->data[r7->data[i5]] = T->data[emlrtDynamicBoundsCheckFastR2012b(i7, 1,
        i6, &q_emlrtBCI, emlrtRootTLSGlobal) - 1];
    }

    /*  Break accumulation if termination criterion has been met */
    /*  ----------------------------------------------------------------------- */
    /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:128' if any(terminate(resp)) */
    ...
    if (b_p) {
      ...
      /*  Update time */
      /*  ----------------------------------------------------------------------- */
      /* 'sam_sim_trial_cffi_ili_nomodbd_inpdepnoise:134' t = t + 1; */
      t++;
...
/* End of code generation (sam_sim_trial_cffi_ili_nomodbd_inpdepnoise.c) */
